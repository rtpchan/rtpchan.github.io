		...
		case 0:
			return $elm$browser$Browser$Events$onKeyUp(
				$author$project$Main$ifIsEnter(
					$author$project$Main$EnterPressed(m)));
		case 3:
			return $elm$browser$Browser$Events$onKeyUp(
				$author$project$Main$ifIsEnter(
					$author$project$Main$EnterPressed(m)));
...
var $author$project$Main$Question = 1;
var $author$project$Main$ShowAnswer = 2;
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $elm$core$String$trim = _String_trim;
var $author$project$Main$check = function (model) {
	var correctAns = $elm$core$String$fromInt(model.E * model.H);
	var scoreUpdate = _Utils_eq(
		correctAns,
		$elm$core$String$trim(model.z)) ? 1 : (-1);
	return _Utils_update(
		model,
		{L: correctAns, l: 2, v: model.v + scoreUpdate});
};
...
var $author$project$Main$focusInputBox = A2(
	$elm$core$Task$attempt,
	function (_v0) {
		return $author$project$Main$NoOp;
	},
	$elm$browser$Browser$Dom$focus('guess-box'));
...
var $author$project$Main$newNumbers = function (model) {
	return A3(
		...
		A2($elm$random$Random$int, 2, 12),
		A2($elm$random$Random$int, 2, 12));
};
var $author$project$Main$newModel = function (model) {
	return A2(
		$elm$random$Random$generate,
		$author$project$Main$ShowQuestion,
		$author$project$Main$newNumbers(model));
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 2:
				...
				return _Utils_Tuple2(
					m,
					$author$project$Main$newModel(m));
			case 3:
				var m = msg.a;
				return _Utils_Tuple2(m, $author$project$Main$focusInputBox);
			case 1:
				var guess = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 0:
				return _Utils_Tuple2(
					$author$project$Main$check(model),
					$elm$core$Platform$Cmd$none);
			case 4:
				var posix = msg.a;
				var tr = model.w - 1;
				return (tr >= 0) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							w: tr,
							K: $elm$time$Time$posixToMillis(posix)
						}),
...
var $author$project$Main$isCorrect = function (m) {
	return _Utils_eq(
		$elm$core$String$fromInt(m.E * m.H),
		$elm$core$String$trim(m.z)) ? A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Press Enter to Start.')
							]))
					]));
		case 1:
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Timer : ' + $elm$core$String$fromInt(model.w))
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Score: ' + $elm$core$String$fromInt(model.v))
							])),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$id('guess-box'),
										$elm$html$Html$Attributes$value(model.z),
										$elm$html$Html$Events$onInput($author$project$Main$Guessing),
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Press Enter to submit your answer.')
							]))
					]));
		case 2:
			return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$isCorrect(model)
									]))
							])),
						A2(
						$elm$html$Html$p,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Press Enter for next question.')
							]))
					]));
		default:
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Your score is ' + $elm$core$String$fromInt(model.v))
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Press Enter for start again.')
							]))
					]));
	}
};
